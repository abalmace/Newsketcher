YUI().add('listaddview',function (Y)
{

	var Lang = Y.Lang;

	/* MyComponent class constructor */
	function ListAddView(data)
	{
		ListAddView.superclass.constructor.apply(this, arguments);
	}
	ListAddView.NAME = "listAddView";
	...
	Y.extend(ListAddView, Y.Base,
	{

		initializer: function(valoresEspeciales)
		{
			//this.client = valoresEspeciales.client;
			...
			TodoView = Y.ModuleView.SpecialListView;
	...
	Y.namespace("ModuleList").ListAddView = ListAddView;

}, "1.0", {requires:['event-focus', 'json', 'model', 'model-list', 'view','base','speciallistview']});
