...
self.app.get('/channel/:subtaskGUID/:userGUID/instanceSubTasks.json', function(req,res)
{
    res.writeHead(200, {
      'Content-Type': 'application/json'
    });
	store.getInstanceSubTasks(req.params.subtaskGUID,req.params.userGUID, function(taskName)
	{
